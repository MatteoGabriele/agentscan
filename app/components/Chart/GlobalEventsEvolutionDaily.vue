...
// Copy of `ChartGlobalEventsEvolution` reading the stored daily rollup instead
// of the scan rows, and without the closure-rate line — a stored day has no PR
// rows behind it to derive one from. The three classification series are all
// this chart plots.
const { data: ecosystemHealth } = await useEcosystemHealthDaily()
