...
<template>
  ...
  >
    <template v-if="isFlaggedAccount">
      <span class="i-lucide:gift text-xl text-gh-muted mx-auto mb-4 block" aria-hidden="true" />
    ...
    <template v-else>
      <span class="i-lucide:ghost text-xl text-gh-muted mx-auto mb-4 block" aria-hidden="true" />
