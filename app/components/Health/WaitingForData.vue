...
<template>
  <section class="flex items-center justify-center flex-col gap-6 h-full">
    <header class="text-center flex items-center flex-col">
      ...
      <div class="text-gh-muted mt-2 flex flex-col text-pretty max-w-lg">
        <p>
          We're currently collecting fresh data to provide you with more accurate ecosystem health
          insights.
        </p>
